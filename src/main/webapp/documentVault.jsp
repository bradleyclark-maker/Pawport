...
.primary-color {
	color: #4F797D;
} /* Pure color from logo background */
.primary-bg {
...
.btn:hover {
	background-color: #B2754E; /* A darker, richer orange on hover */
}
...
<body>
	...
	<div class="container">
		<div class="header-section">
			<img src="Images/logoWithoutPawPort.png" alt="PawPort Logo"
				style="height: 60px; margin-right: 20px;">
			<h1 class="primary-color">PawPort Document Vault</h1>
		</div>

		<p style="color: #6c757d; max-width: 600px; margin-bottom: 30px;">Securely
			store and manage your pet's vital records, vaccinations, and
			certifications.</p>

		<div class="upload-box">
			<h3>Upload a New Document</h3>
			<form action="DocumentVault" method="post"
				enctype="multipart/form-data">
				<div style="margin-bottom: 20px;">
					<label>File Selection (e.g., PDF or Image):</label> <input
						type="file" name="file" required
						style="border: 1px solid #D1D5DB; padding: 10px; width: calc(100% - 22px); border-radius: 6px;">
				</div>
				<div style="margin-bottom: 25px;">
					<label>Document Category:</label> <select name="category"
						style="border: 1px solid #D1D5DB; padding: 10px; width: 100%; border-radius: 6px; font-size: 1em;">
		...
		<h3 class="primary-color" style="margin-bottom: 20px;">Stored
			Records</h3>
		<table>
			<thead>
				<tr>
