	...
	<div class="viewport-wrapper">
		<div class="register-card">
			...
			<form action="register" method="POST">
				...
				<div class="form-group">
					<label>Last Name</label> <input type="text" name="reglname"
						placeholder="Last Name" required />
				</div>

				<div class="form-group">
					<label>Email</label> <input type="email" name="regEmail"
						placeholder="email@example.com" required />
				</div>

				<div class="form-group">
					<label>Phone</label> <input type="tel" name="regPhone"
						placeholder="123-456-7890" required />
				</div>

				<div class="form-group">
					<label>Password</label> <input type="password" name="regPassword"
						pattern="(?=.*[A-Z])(?=.*[!@#$%^&*]).{8,}"
